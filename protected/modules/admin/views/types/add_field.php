...
<main>
    ...
    <div class="content menu-content">
        ...
        <div class="header">
            <span><?php echo __a('Add field'); ?></span>
        </div><!--/header-->
                ...
                <?php foreach($languages as $index => $lng): ?>
                    <table data-tab="<?php echo $lng->id; ?>" <?php if($index == 0): ?>class="active"<?php endif;?>>
                        <tr>
                            ...
                            <td class="value"><input type="text" name="ContentItemFieldEx[name][<?php echo $lng->id; ?>]" value=""></td>
                        </tr>
                        <tr>
                            <td class="label"><?php echo __a('Description'); ?> [<?php echo $lng->prefix; ?>]:</td>
                            <td class="value"><textarea name="ContentItemFieldEx[description][<?php echo $lng->id; ?>]"></textarea></td>
                        </tr>
                    </table>
                <?php endforeach;?>
            </div><!--/tabs-->
