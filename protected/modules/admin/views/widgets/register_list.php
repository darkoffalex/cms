                    ...
                    <ul class="actions">
                        <li>
                            <form method="post" action="<?php echo Yii::app()->createUrl('admin/widgets/register'); ?>" class="special-filter-form">
                                ...
                                <select name="reg_id" class="float-left filter-drop-down">
                    ...
                    <?php foreach($position->widgetRegistrations as $wr): ?>
                        <div class="list-row h94">
                            ...
                            <div class="cell action bigger">
                                ...
                                <a href="<?php echo Yii::app()->createUrl('admin/widgets/unregister',array('id' => $wr->id, 'dir' => 'up')); ?>" class="action delete"></a>
                            </div>
                        </div><!--/list-row-->
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="content list">
                        <div class="list-row">
                            <div class="cell"><?php echo __a('No widgets are registered fot his position'); ?></div>
                        </div><!--/list-row-->
                    </div>
                <?php endif; ?>
