...
/**
 * This is the model class for table "translation_trl".
 *
 * The followings are the available columns in table 'translation_trl':
 * @property integer $id
 ...
 */
class TranslationTrl extends CActiveRecord
{
	/**
	 ...
	 * @return TranslationTrl the static model class
	 */
