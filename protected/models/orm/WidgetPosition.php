...
/**
 * This is the model class for table "widget_position".
 *
 * The followings are the available columns in table 'widget_position':
 * @property integer $id
 ...
 */
class WidgetPosition extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'widgetRegistrations' => array(self::HAS_MANY, 'WidgetRegistration', 'position_id'),
		);
	}
	 ...
	 * @return WidgetPosition the static model class
	 */
