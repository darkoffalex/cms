...
class Controller extends CController
{
    ...
    protected function beforeAction($action)
    {
        ...
        DynamicForms::getInstance()->feedbackFormRequestHandle(Yii::app()->getRequest());

        //regenerate captcha (use this only after CAPTCHA checking)
        DynamicForms::getInstance()->regenerateCaptchaCode();
